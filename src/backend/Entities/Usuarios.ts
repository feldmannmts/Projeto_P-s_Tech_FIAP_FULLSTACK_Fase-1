import {IPerfilUsuario, IUsuario, NivelAcesso} from "./Interfaces/IUsuario";
...
class PerfilUsuario implements IPerfilUsuario {
      nomePerfil = '';
      descricaoPerfil = '';
      nivelAcesso = {} as NivelAcesso;
      usuario = {} as IUsuario;

      constructor(_nomePerfil: string, _descricaoPerfil: string, _nivelAcesso: NivelAcesso, _usuario: IUsuario) {
